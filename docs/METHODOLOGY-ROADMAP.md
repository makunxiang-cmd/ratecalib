...
## 三、目标可行性预检：**能给什么、不能给什么**（批判性澄清）· P1（范围收窄）
...
## 四、Excel 数据输入 / 输出兼容 · P1（实用价值高、独立、低风险）
